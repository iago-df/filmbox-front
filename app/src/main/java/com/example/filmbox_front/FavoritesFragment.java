...
public class FavoritesFragment extends Fragment {
    ...
    public FavoritesFragment() {
        super(R.layout.fragment_favorites); // Asegúrate de que este layout tiene el header y RecyclerView
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        backArrow.setOnClickListener(v -> {
            // Volver al fragment anterior (ProfileFragment)
                    ...
                    public void onResponse(Call<List<FilmResponse>> call, Response<List<FilmResponse>> response) {
                        if (response.isSuccessful() && response.body() != null) {
                            ...
                            recyclerView.setAdapter(
                                    new MovieAdapter(requireContext(), urls, pos -> {})
                            );
                        }
                    }
